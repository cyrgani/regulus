...
assert_eq(catch(first(list())), "<stl:lists>:13:11: IndexError: sequence index out of bounds"),
assert_eq(catch(last(list())), "IndexError: invalid list index: out of range integral type conversion attempted"),
assert_eq(catch(first("")), "<stl:lists>:13:11: IndexError: sequence index out of bounds"),
